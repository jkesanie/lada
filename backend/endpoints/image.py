...
class Image(object):
    ...
    def on_get(self, req, resp):
        ...
        resp.set_header('Content-Disposition', 'attachment;filename=' + str(id) + '.svg')
    ...
    def on_post(self, req, resp):
        ...
        template = """
          <style type="text/css">
            ...
            """
        result = '<svg class="rv-xy-plot__inner" xmlns="http://www.w3.org/2000/svg" width="' + str(width) + '" height="' + str(height) + '">' + template + svg + '</svg>'
